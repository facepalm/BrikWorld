...
Modeling magic in BrikWorld is easily its most freeform aspect.  Given a reasonably appropriate
...
No matter how skilled you are in life, no matter how many battles you've fought or awards you've won, you'll never get any respect if you don't have the hat to  prove it.  A helmet of any kind is the generally accepted and often best way of marking special units: those with uncommon specializations or using special equipment.  Basic helmets only provide a small amount of armor, but certain enhancements are helmet-specific.
