...
By now the players have gotten a taste of fighting death beetles, so it's up to them whether they want to clear out the nest.  Structurally, the nest should be a mess of winding tunnels leading to heavily-defended food and egg caches.  The majority of beetles can be found in the main egg chamber, which should be roomy enough to have a big fight where everyone gets to take a swing at the same time.  There are additional skeletonized corpses in this room holding more treasure.
...
\item Imta
\item Inkishush
\item Zagros (for a mountain fort)
\item Shulme
\item Alyattes
\end{itemize}
